...
@php
    ...
    $allShortcuts = [
        ...
        ['group' => 'Overview',  'icon' => 'tag',        'label' => 'Item Sales',           'route' => 'itemSales.index',                  'desc' => 'Per-item sales with cost %'],
        ['group' => 'Overview',  'icon' => 'board',      'label' => 'Order Board',          'route' => 'reports.orderBoard',               'desc' => 'Per-bill order board view'],
        ['group' => 'Reports',   'icon' => 'activity',   'label' => 'Activity Logs',        'route' => 'reports.activityLog',              'desc' => 'Staff and system activity'],
        ['group' => 'Reports',   'icon' => 'market',     'label' => 'Market List',          'route' => 'reports.marketList',               'desc' => 'Inventory and market list'],
        ['group' => 'Reports',   'icon' => 'factory',    'label' => 'Production Summary',   'route' => 'reports.productionSummary',        'desc' => 'Production by category and UOM'],
        ['group' => 'Reports',   'icon' => 'card',       'label' => 'Production Card',      'route' => 'reports.productionCard.index',     'desc' => 'Browse production cards'],
        ['group' => 'Reports',   'icon' => 'purchase',   'label' => 'Purchase Summary',     'route' => 'reports.purchaseSummary',          'desc' => 'Purchase summary by item'],
        ['group' => 'Reports',   'icon' => 'detail',     'label' => 'Purchase Detail',      'route' => 'reports.purchaseDetail',           'desc' => 'Detailed purchase lines'],
        ['group' => 'Reports',   'icon' => 'partner',    'label' => 'Purchase By Partner',  'route' => 'reports.purchaseDetailPartner',    'desc' => 'Purchases grouped by partner'],
        ['group' => 'Reports',   'icon' => 'stock',      'label' => 'Physical Stock Count', 'route' => 'reports.physicalStockCountSummary','desc' => 'Stock count by warehouse'],
        ['group' => 'Reports',   'icon' => 'recipe',     'label' => 'Recipes Report',       'route' => 'reports.recipe',                   'desc' => 'Recipe list and details'],
        ['group' => 'Reports',   'icon' => 'recipe',     'label' => 'Recipe Board',         'route' => 'reports.recipe-board',             'desc' => 'Recipes with ingredient breakdown'],
        ['group' => 'Reports',   'icon' => 'transfer',   'label' => 'Transfer Detail',      'route' => 'reports.transferDetail',           'desc' => 'Stock transfers by category'],
        ['group' => 'Reports',   'icon' => 'waste',      'label' => 'Waste Summary',        'route' => 'reports.wasteSummary',             'desc' => 'Waste by item and category'],
        ['group' => 'Settings',  'icon' => 'staff',      'label' => 'Staff Settings',       'route' => 'settings.staff',                   'desc' => 'Manage staff accounts'],
        ['group' => 'Settings',  'icon' => 'security',   'label' => 'Security Settings',    'route' => 'settings.security',                'desc' => 'Manage route access'],
    ];
