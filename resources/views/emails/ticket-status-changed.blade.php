      ...
      <table role="presentation" width="600" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:32px;">
            <p style="margin:0 0 8px;font-size:18px;font-weight:700;color:#141414;">Ticket Status Updated</p>
            <p style="margin:0 0 24px;font-size:14px;color:#6b6b6b;">
              Hello {{ $ticket->submitter_name }}, the status of your support ticket has been updated.
            </p>
            ...
            <table role="presentation" width="100%" style="border:1px solid #e5e7eb;border-radius:6px;overflow:hidden;margin-bottom:24px;">
              ...
              <tr>
                <td style="padding:10px 16px;font-size:13px;font-weight:600;color:#374151;border-bottom:1px solid #f3f4f6;">Previous Status</td>
                <td style="padding:10px 16px;font-size:13px;color:#6b7280;border-bottom:1px solid #f3f4f6;">{{ \App\Models\Ticket::STATUS_LABELS[$oldStatus] ?? $oldStatus }}</td>
              </tr>
              <tr>
                <td style="padding:10px 16px;font-size:13px;font-weight:600;color:#374151;">New Status</td>
                <td style="padding:10px 16px;font-size:13px;font-weight:700;color:#059669;">{{ \App\Models\Ticket::STATUS_LABELS[$newStatus] ?? $newStatus }}</td>
              </tr>
            </table>

            @if($newStatus === 'resolved')
            <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:6px;padding:14px 16px;margin-bottom:16px;">
              <p style="margin:0;font-size:13px;color:#166534;line-height:1.6;">
                Your ticket has been marked as <strong>Resolved</strong>. If you feel your issue is not fully addressed, please submit a new ticket referencing this number.
              </p>
            </div>
            @endif
            ...
            <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:6px;padding:14px 16px;">
              <p style="margin:0;font-size:13px;color:#374151;line-height:1.6;">
                Check your ticket status at any time:
